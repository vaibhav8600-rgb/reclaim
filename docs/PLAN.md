...
- Apple Health import: parsing (segments → nights, pounds → kg, junk skipped), semicolon lines with thousands and decimal commas, paste import, idempotency
