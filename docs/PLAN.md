...
- Safe recovery: warning signs picked by injury region, weekly and after a nerve symptom, a ticked sign saved with the right urgency; adjust-for notes across injuries (one per region), on the exercise page and sent to the AI
